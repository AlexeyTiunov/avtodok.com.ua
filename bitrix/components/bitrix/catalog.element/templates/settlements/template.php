            ...
            <td valign="top">
                <!--<?foreach($arResult["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
                    ...
                    elseif($pid=="MANUAL"):
                        ...
                        echo $arProperty["DISPLAY_VALUE"].$pid;?>
                    <?endif?></b><br />
                <?endforeach?>-->
                <?php 
                global $SummITG,$CurrencyCodeITG;
                $SummITG = $arResult['DISPLAY_PROPERTIES']['Summ']['DISPLAY_VALUE'];
                $CurrencyCodeITG = $arResult['DISPLAY_PROPERTIES']['CurrencyCode']['DISPLAY_VALUE'];
                $arAgrs = GetAgreementsList();
                echo "<b>Накладная №{$arResult['DISPLAY_PROPERTIES']['Code']['DISPLAY_VALUE']} от {$arResult['DISPLAY_PROPERTIES']['DocumentDate']['DISPLAY_VALUE']}</b><br/>";
                foreach ($arAgrs as $argprop)
                {
                    if ($argprop['Code'] == $arResult['DISPLAY_PROPERTIES']['AgreementCode']['DISPLAY_VALUE'])
                    {
                        echo "<b>Договор: {$argprop['Caption']}</b><br/>";
                    }
                }
                ?>
            </td>

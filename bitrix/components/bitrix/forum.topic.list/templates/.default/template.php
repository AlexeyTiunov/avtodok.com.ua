...
?>
	<span class="forum-option-subscribe">
		<noindex><a rel="nofollow" title="<?=GetMessage("F_SUBSCRIBE_TO_NEW_POSTS")?>" href="<?=$APPLICATION->GetCurPageParam("ACTION=FORUM_SUBSCRIBE&".bitrix_sessid_get(), 
...
?>
							<span class="forum-footer-option forum-footer-markread forum-footer-option-first"><?
								?><noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("ACTION=SET_BE_READ&".bitrix_sessid_get(), array("ACTION", "sessid"))
									?>"><?=GetMessage("F_SET_FORUM_READ")?></a></noindex></span>
<?
						endif;
						if ($arResult["PERMISSION"] >= "Q"):
?>

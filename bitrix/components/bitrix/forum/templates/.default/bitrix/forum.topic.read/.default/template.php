...
?>
		&nbsp;&nbsp;
		<span class="forum-option-subscribe"><noindex><a rel="nofollow" title="<?=GetMessage("F_SUBSCRIBE_TITLE")?>" href="<?
...
function ShowFirstPost(oA)
{
	...
	{
		div.style.display = '';
		oA.innerHTML = '<?=CUtil::JSUrlEscape(GetMessage("F_COLLAPSE"))?>';
	}
	else
	{
		div.style.display = 'none';
		oA.innerHTML = '<?=CUtil::JSUrlEscape(GetMessage("F_SHOW"))?>';
	}

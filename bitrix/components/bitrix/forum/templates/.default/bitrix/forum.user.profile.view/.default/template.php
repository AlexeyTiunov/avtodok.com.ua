...
$arUserOptions = @unserialize(CUserOptions::GetOption("forum", "profile", "", $arParams["UID"]));
...
?>
					<div class="forum-user-status <?=(!empty($arResult["USER_RANK_CODE"]) ? "forum-user-".$arResult["USER_RANK_CODE"]."-status" : "")?>"><?
						?><span><?=$arResult["USER_RANK"]?></span></div>
<?
else:
?>
					<div class="forum-user-status <?=(!empty($arResult["USER_RANK_CODE"]) ? "forum-user-".$arResult["USER_RANK_CODE"]."-status" : "")?>"><?
						?><span><?=$arResult["arRank"]["NAME"]?></span></div>
...
?>
	...
	if ($arResult["SHOW_VOTES"] == "Y"):
						?>&nbsp;(<span class="forum-vote-user"><?
							?><noindex><a rel="nofollow" href="<?=$arResult["URL"]["VOTE"]?>" title="<?
...
?>
					<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("option=photo&value=".
						($arResult["USER"]["SHOW_PANELS"]["photo"] == "Y" ? "hide" : "show")."&".bitrix_sessid_get(), array("option", "value", "sessid"))?>"><?
...
?>
					<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("option=private&value=".
						($arResult["USER"]["SHOW_PANELS"]["private"] == "Y" ? "hide" : "show")."&".bitrix_sessid_get(), array("option", "value", "sessid"))?>"><?
...
?>
					<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("option=work&value=".
						($arResult["USER"]["SHOW_PANELS"]["work"] == "Y" ? "hide" : "show")."&".bitrix_sessid_get(), array("option", "value", "sessid"))?>"><?
...
?>
					<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("option=user_prop&value=".
						($arResult["USER"]["SHOW_PANELS"]["user_prop"] == "Y" ? "hide" : "show")."&".bitrix_sessid_get(), array("option", "value", "sessid"))?>"><?

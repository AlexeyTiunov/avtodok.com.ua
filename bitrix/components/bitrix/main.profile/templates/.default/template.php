...
<div class="profile-link profile-user-div-link">Регистрационные данные</a></div>
...
<table class="profile-table data-table">
	...
	?>
		...
		<tr>
			<td><? if ($LANGUAGE=="RUS")
             echo GetMessage('LAST_UPDATW');
               else
             echo GetMessage('LAST_UPDATEUKR');
            ?></td>
	...
	?>
	<tr>
		<td> <?=($LANGUAGE=="RUS")?"Наименование:":"Найменування:"?> </td>
	...
	<tr>
		<td><?=($LANGUAGE=="RUS")?"Логин:":"Логін:"?></td>
		<td>
	...
	<tr>
		<td> <?if ($LANGUAGE=="RUS")
            ...
            echo  GetMessage('NEW_PASSWORD_REQUKR');?> </td>
	...
	<tr>
		<td><?if ($LANGUAGE=="RUS")
            ...
            echo  GetMessage('NEW_PASSWORD_CONFIRM');?></td>
...
<table class="data-table profile-table">
	...
	<?endif;?>
	<?// ******************** /User properties ***************************************************?>
	<p id="wer"><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p>

...
else
{
   ...
   # $menu->Init($arParams["DIRTOFINDFROM"], $arParams["USE_EXT"], $componentPath."/stub.php");
   #$menu->Init("/", $arParams["USE_EXT"], $componentPath."/stub.php");
   ...
   if ($LANGUAGE=="UKR")
   $menu->Init("/bitrix/templates/avtodokukr/", $arParams["USE_EXT"], $componentPath."/stub.php");
   else
   $menu->Init("/bitrix/templates/avtodok/", $arParams["USE_EXT"], $componentPath."/stub.php");     
     
	$menu->RecalcMenu($arParams["ALLOW_MULTI_SELECT"]);

	$arResult = Array();
    $arResult["CheckParams"]=$arParams["DIRTOFINDFROM"];

...
$MESS ['CC_BSC1_ITEMSTATUS'] = "СтатусСтроки";
$MESS ['CC_BSC1_ITEMSTATUS2'] = "СтатусСтроки2"; 
$MESS ['CC_BSC1_WAREHOUSEDATE'] = "ДатаСклад"; 
$MESS ['CC_BSC1_ITEMSTATUSQUANTITY'] = "СтатусСтрокиКоличество";
$MESS ['CC_BSC1_ITEMSTATUSQUANTITY2'] = "СтатусСтрокиКоличество2";
$MESS['CC_BSC1_ITEMSTATUSQUANTITY_TEXT']="УВ. КЛИЕНТ. ОБРАТИТЕ ВНИМАНИЕ ,ЧТО ПО ДАННОЙ ПОЗИЦИИ ВЫКУПЛЕНО НЕ ВСЕ КОЛЛИЧЕСТВО ЗАКАЗАННЫХ ДЕТАЛЕЙ";
$MESS ['CC_BSC1_ARTICLE'] = "Артикул";
$MESS ['CC_BSC1_ARTICLECHANGE'] = "АртикулБыло";  
$MESS ['CC_BSC1_BRAND'] = "Бренд";
$MESS ['CC_BSC1_USERORDERCODE'] = "КодЗаказаКлиента";
...
$MESS ['CC_BSC1_CURRENCY'] = "Валюта";
$MESS ['CC_BSC1_AGREEMENT'] = "Договор";
$MESS ['CC_BSC1_LOGIN'] = "Логин";
$MESS ['CC_BSC1_REGION'] = "Регион";
?>
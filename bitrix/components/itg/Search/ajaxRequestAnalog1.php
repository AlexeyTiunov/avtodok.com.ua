           ...
           # $infoArray=$sAnalogs->GetInfoFromMegaP() ;
			if (count($products) > 0)
			{
				foreach ($products as $product)
				{
                    ...
                    {
                        $delivery =  "<strong>".$product['DeliveryDays']." </strong>";
                           ...
                           " ;                  
                            ...
                            if ($product['Pic64Base']!="")  
                            {
                                ...
                                {               
                                 ...
                                 $printRow .="<br> <div class='search_table_item_icon'><img src='data:image/png;base64,{$product['Pic64Base']}' style='width:30px;height:30px'></div>";  
                                } else
                                {
                                  $printRow .="<br> <div class='search_table_item_icon'><img src='data:image/png;base64,{$product['Pic64Base']}' style='width:30px;height:30px'></div>";  
                                  $printRow .="<div class='search_table_item_icon'><img src='/bitrix/templates/avtodok/images/1_garant.png' style='width:30px;height:30px'></div>";    
                                }

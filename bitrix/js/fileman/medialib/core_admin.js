...
BXMedialibAdmin.prototype =
{
			...
			handler: function()
			{
				if (window.bx_req_res !== false)
				{
					...
					else
					{
						...
						pTitle.childNodes[3].innerHTML = oCol.name;
	...
	TypeOnChange: function(Params)
	{
		if (this.Types[Params.typeInd].id != this.curType.id)
			window.location = "/bitrix/admin/fileman_medialib_admin.php?lang=" + this.oConfig.lang + "&type=" + this.Types[Params.typeInd].id;
	},

...
{
	$str_NAME = htmlspecialcharsEx(Trim($NAME));
...
{
	$str_ID = $arGroup["ID"];
	$str_NAME = htmlspecialcharsEx($arGroup["NAME"]);
...
$sDocTitle = ($ID>0) ? eregi_replace("#ID#", "$ID", GetMessage("CAT_EDIT_RECORD")) : GetMessage("CAT_NEW_RECORD");

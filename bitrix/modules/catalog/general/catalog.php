...
class CAllCatalog
{
	...
	{
		if ((is_set($arFields, "SUBSCRIPTION") || $ACTION=="ADD") && $arFields["SUBSCRIPTION"] != "N")
			$arFields["SUBSCRIPTION"] = "Y";
	...
	function GetByID($ID)
	{
		...
		{
			$strSql =
				"SELECT CI.IBLOCK_ID as IBLOCK_ID, CI.YANDEX_EXPORT, CI.SUBSCRIPTION, CI.VAT_ID, ".

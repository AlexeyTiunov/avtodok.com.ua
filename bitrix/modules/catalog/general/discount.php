		...
		else
		{
			...
			if (count($arDiscountIDs) > 0)
			{
				...
				$dbPriceDiscount = CCatalogDiscount::GetList(
					...
					false,
					false,
					array("ID", "SITE_ID", "ACTIVE", "ACTIVE_FROM", "ACTIVE_TO", "RENEWAL", "NAME", "MAX_USES", "COUNT_USES", "SORT", "MAX_DISCOUNT", "VALUE_TYPE", "VALUE", "CURRENCY", "MIN_ORDER_SUM", "TIMESTAMP_X", "NOTES", "COUPON")
				);

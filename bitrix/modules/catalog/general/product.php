				...
				if ($arProp = $dbProps->Fetch())
				{
					...
					do
					{
						if (strlen($arProp["CODE"])>0)
							$arAllProps[$arProp["CODE"]] = Array("NAME"=>htmlspecialchars($arProp["NAME"]), "VALUE"=>htmlspecialchars($arProp["VALUE"]), "DEFAULT_VALUE"=>htmlspecialchars($arProp["DEFAULT_VALUE"]), "SORT"=>htmlspecialchars($arProp["SORT"]));
						else
							$arAllProps[$arProp["ID"]] = Array("NAME"=>htmlspecialchars($arProp["NAME"]), "VALUE"=>htmlspecialchars($arProp["VALUE"]), "DEFAULT_VALUE"=>htmlspecialchars($arProp["DEFAULT_VALUE"]), "SORT"=>htmlspecialchars($arProp["SORT"]));
					}

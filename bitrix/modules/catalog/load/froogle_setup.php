		...
		<table width="100%">
			<tr>
				...
				<td width="100%" valign="top">
					<select name="IBLOCK_ID" OnChange="document.getElementById('ifr').src='/bitrix/tools/catalog_export/froogle_util.php?IBLOCK_ID='+this[this.selectedIndex].value;">
...
//										space = '<input type="checkbox" name="V[]" value="'+i+'"><a href="' + Tree[node][i][1] + '">' + Tree[node][i][0] + '</a>';
					...
					<iframe src="/bitrix/tools/catalog_export/froogle_util.php?IBLOCK_ID=<?=$IBLOCK_ID?>" id="ifr" name="ifr" style="display:none"></iframe>
					<br><br>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="100%" valign="top">
					<font class="text">
					<?echo GetMessage("CET_SAVE_FILENAME");?> <input type="text" name="SETUP_FILE_NAME" value="<?echo (strlen($SETUP_FILE_NAME)>0) ? htmlspecialchars($SETUP_FILE_NAME) : (COption::GetOptionString("catalog", "export_default_path", "/upload/"))."froogle.txt" ?>" size="50">
					</font>
					<br><br>
				</td>
			</tr>
			...
			<?if ($ACTION=="EXPORT_SETUP"):?>
				<tr>
					...
					<td width="100%" valign="top">
						<font class="text">
						<?echo GetMessage("CET_PROFILE_NAME");?> <input type="text" name="SETUP_PROFILE_NAME" value="" size="30">
						</font>
						<br><br>
					</td>
				</tr>

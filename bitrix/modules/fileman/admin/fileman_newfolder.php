...
if ($USER->CanDoFileOperation('fm_create_new_folder',$arPath))
{
	...
	?>
	<tr>
		<td width="40%"><?=GetMessage("FILEMAN_NEWFOLDER_NAME")?></td>
		<td width="60%"><input type="text" name="foldername" value="<?=htmlspecialcharsex($foldername)?>" size="30" maxlength="255"></td>
	</tr>
	<tr>
		<td><?=GetMessage("FILEMAN_NEWFOLDER_SEACTION_NAME")?></td>
		<td><input type="text" name="sectionname" value="<?=htmlspecialcharsex($sectionname)?>" size="30" maxlength="255"></td>
	</tr>

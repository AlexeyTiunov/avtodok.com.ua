arButtons['new'] = ['BXButton',
	{
		...
		handler : function ()
		{
			setTimeout(function(){new_doc_list.PopupShow(BX.pos(this.pWnd)); BX("new_doc_list").style.zIndex = 2100;}, 10);
		}
	}
];
	...
	arButtons['pageprops'] = ['BXButton',
		{
			...
			{
				this.bNotFocus = true;
				this.pMainObj.OpenEditorDialog("pageprops", false, 700, {window: window, document: document});
			}
		}
	];

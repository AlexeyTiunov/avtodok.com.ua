...
$lAdmin->AddHeaders(array(
	...
	array("id"=>"MIN_POINTS","content"=>GetMessage("FORUM_P_MIN_POINTS"), "sort"=>"MIN_POINTS", "default"=>true, "align"=>"right"),
	array("id"=>"VOTES", "content"=>GetMessage("FORUM_P_VOTES"), "sort"=>"VOTES", "default"=>true, "align"=>"right"),
));

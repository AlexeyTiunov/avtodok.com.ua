...
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/forum/classes/general/functions.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/forum/classes/".$DBType."/filter_dictionary.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/forum/classes/".$DBType."/forum_new.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/forum/classes/".$DBType."/topic.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/forum/classes/".$DBType."/message.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/forum/classes/".$DBType."/private_message.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/forum/classes/".$DBType."/user.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/forum/classes/".$DBType."/points.php");

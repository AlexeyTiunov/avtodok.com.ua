...
elseif (intVal($arResult["FILE"]["MESSAGE_ID"]) > 0)
{
	...
	if (empty($arParams["PERMISSION"]))
	{
		...
		if ($arParams["PERMISSION"] < "E" && (intVal($arResult["TOPIC"]["SOCNET_GROUP_ID"]) > 0 || 
			intVal($arResult["TOPIC"]["OWNER_ID"]) > 0))
		{
			...
			if ($group_id):
				if (CSocNetFeaturesPerms::CanPerformOperation($user_id, SONET_ENTITY_GROUP, $group_id, "forum", "full", $GLOBALS['USER']->IsAdmin())):
					$arParams["PERMISSION"] = "Y";
				elseif (CSocNetFeaturesPerms::CanPerformOperation($user_id, SONET_ENTITY_GROUP, $group_id, "forum", "newtopic", $GLOBALS['USER']->IsAdmin())):
					$arParams["PERMISSION"] = "M";
				elseif (CSocNetFeaturesPerms::CanPerformOperation($user_id, SONET_ENTITY_GROUP, $group_id, "forum", "answer", $GLOBALS['USER']->IsAdmin())):
					$arParams["PERMISSION"] = "I";
				elseif (CSocNetFeaturesPerms::CanPerformOperation($user_id, SONET_ENTITY_GROUP, $group_id, "forum", "view", $GLOBALS['USER']->IsAdmin())):
				...
				if (CSocNetFeaturesPerms::CanPerformOperation($user_id, SONET_ENTITY_USER, $owner_id, "forum", "full", $GLOBALS['USER']->IsAdmin())):
					$arParams["PERMISSION"] = "Y";
				elseif (CSocNetFeaturesPerms::CanPerformOperation($user_id, SONET_ENTITY_USER, $owner_id, "forum", "newtopic", $GLOBALS['USER']->IsAdmin())):
					$arParams["PERMISSION"] = "M";
				elseif (CSocNetFeaturesPerms::CanPerformOperation($user_id, SONET_ENTITY_USER, $owner_id, "forum", "answer", $GLOBALS['USER']->IsAdmin())):
					$arParams["PERMISSION"] = "I";
				elseif (CSocNetFeaturesPerms::CanPerformOperation($user_id, SONET_ENTITY_USER, $owner_id, "forum", "view", $GLOBALS['USER']->IsAdmin())):
					$arParams["PERMISSION"] = "E";
				endif;
			endif;

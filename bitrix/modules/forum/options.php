...
?>
	...
	<tr>
		<td valign="top"><label for="SHOW_TASKBAR_ICON"><?= GetMessage("FORUM_GG_TOOLBAR")?>:<br>
				<small><?= GetMessage("FORUM_GG_TOOLBAR_DESCR") ?></small></label></td>
		<td valign="middle">
			<?$val = COption::GetOptionString("forum", "SHOW_TASKBAR_ICON", "N");?>
			<input type="checkbox" value="Y" name="SHOW_TASKBAR_ICON" id="SHOW_TASKBAR_ICON" <?if ($val=="Y") echo "checked";?>></td>
	</tr>
	<tr>

...
<script type="text/javascript">
	...
	function SWFStatListenerp<?=$arResult['PREFIX']?>(obj)
	{
		...
		if(jsPublicTVCollector.tv[<?=$arResult['PREFIX']?>].GatherStatistics)
			jsPublicTVCollector.StatEvent(jsPublicTVCollector.tv[<?=$arResult['PREFIX']?>].Player['flv'], obj.oldstate, obj.newstate);
	}

...
if($this->StartResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))
{
	...
	while($obElement = $rsElements->GetNextElement())
	{
		...
		elseif($arProperties["DOC_LINK"]["VALUE"])
			$arItem["link"]=strpos($arProperties["DOC_LINK"]["VALUE"], "http://")!==0? "http://".$arResult["SERVER_NAME"].$arProperties["DOC_LINK"]["VALUE"]: $arProperties["DOC_LINK"]["VALUE"];
		else
			$arItem["link"]=strpos($arElement["DETAIL_PAGE_URL"], "http://")!==0? "http://".$arResult["SERVER_NAME"].$arElement["DETAIL_PAGE_URL"]: $arElement["DETAIL_PAGE_URL"];
		...
		{
			$arItem["enclosure"] = array(
				"url" => "http://".$arResult["SERVER_NAME"].$arElement["arr_PREVIEW_PICTURE"]["SRC"],

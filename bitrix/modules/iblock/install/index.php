...
Class iblock extends CModule
{
	...
	function DoInstall()
	{
		...
		$step = IntVal($step);
		if($step<2)
			$APPLICATION->IncludeAdminFile(GetMessage("IBLOCK_INSTALL_TITLE"), $DOCUMENT_ROOT."/bitrix/modules/iblock/install/step1.php");
		elseif($step==2)
		{
			if($this->InstallDB())
			{
			...
			$APPLICATION->IncludeAdminFile(GetMessage("IBLOCK_INSTALL_TITLE"), $DOCUMENT_ROOT."/bitrix/modules/iblock/install/step2.php");
		}
	}
	...
	function DoUninstall()
	{
		...
		$step = IntVal($step);
		if($step<2)
			$APPLICATION->IncludeAdminFile(GetMessage("IBLOCK_INSTALL_TITLE"), $DOCUMENT_ROOT."/bitrix/modules/iblock/install/unstep1.php");
		elseif($step==2)
		{
			...
			$this->UnInstallFiles();
			$GLOBALS["errors"] = $this->errors;
			$APPLICATION->IncludeAdminFile(GetMessage("IBLOCK_INSTALL_TITLE"), $DOCUMENT_ROOT."/bitrix/modules/iblock/install/unstep2.php");
		}
	}
}
?>
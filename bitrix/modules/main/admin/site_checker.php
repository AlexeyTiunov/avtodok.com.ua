...
?>
	...
	<?
		$val = ini_get('allow_call_time_pass_reference');
	?>
	<tr>
...
#						ShowResult(GetMessage("SC_NO_TEMP_FOLDER"), "E");
	...
	<tr>
		...
		<td valign="top"><?=GetMessage("SC_SETTED")?></td>
		<td valign="top"><?= (function_exists("imagecreatetruecolor") && function_exists("imagejpeg") ? ShowResult(GetMessage("SC_SETTED"), "O") : ShowResult(GetMessage("SC_NOT_SETTED"), "E"))?></td>
	</tr>
	<? if ($bUtf) : ?>
	<tr>

	...
	function Install()
	{
		...
		elseif ($this->pathToScript)
		{
			...
			if($this->arDescription["PARENT"] == "wizard_sol")
			{
				...
				if ($lang != "en" && $lang != "ru")
					if (file_exists($wizardPath."/lang/en/".$relativePath))
						__IncludeLang($wizardPath."/lang/en/".$relativePath);

				if (file_exists($wizardPath."/lang/".$lang."/".$relativePath))
					__IncludeLang($wizardPath."/lang/".$lang."/".$relativePath);
			}

...
if (in_array("PERSONAL_PHOTO", $arParams["SHOW_FIELDS"]) && intval($arResult["User"]["PERSONAL_PHOTO"]) > 0)
{
...
$strCard .= '<div class="bx-user-info-data-info">'.$strTmpUserFields.$strTmpUserProperties.'</div>';
$strCard .= '</div>';
?>
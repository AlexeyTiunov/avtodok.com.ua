...
$MESS ['SUP_USERS'] = "Number of users:";
...
$MESS ['SUP_SUAC_LIMIT1'] = "You can not add more than #NUM# users for the current product copy.";
...
$MESS ['SUP_SUBV_HINT'] = "A \"Beta version\" is a piece of update that has been tested internally by the developers prior to its release. Beta versions include latest changes and fixes, and are relatively stable but may cause misoperations in some cases.";
...
$MESS ['SUP_MYSQL_L4111'] = "You are using MySql version #VERS#, but the system requires version 4.1.11 or higher. Please update your MySql installation or contact the technical support.";
$MESS ['SUP_PHP_L439'] = "You are using PHP version #VERS#, but the system requires version 5.0.0 or higher. Please update your PHP installation or contact the technical support.";

...
$MESS["MAIN_OPTION_HTML_CACHE_WARNING"] = "Внимание! Установлены модули статистики или рекламы. Для HTML кеширования учет данных будет вестись не корректно.";
...
$MESS["cache_admin_note1"] = "<table width=\"100%\" border=\"0\" cellpadding=\"5\" cellspacing=\"0\">
		...
		<tr>
				<td valign=\"top\"><br />
				Обратите внимание: при использовании режима &quot;Автокеширования&quot;, обновление информации, выводимой компонентами, происходит в соответствии с параметрами отдельных компонентов. </td>
		</tr>
		<tr>
				<td valign=\"top\"><br />
				Для того чтобы обновить содержимое закешированных объектов на странице, вы можете: </td>
		</tr>
</table>
...
<br />
<p>Примечание: При включении режима автокеширования компонентов, компоненты с настройкой кеширования <i>\"Авто\"</i> будут переведены в режим работы с кешированием.<br />
<br />
...
<br />
Компоненты с настройкой кеширования <i>\"Не кешировать \"</i> или временем кеширования равным нулю, всегда работают без кеширования.</p>";

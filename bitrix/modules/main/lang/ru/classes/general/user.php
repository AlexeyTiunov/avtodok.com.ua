...
$MESS ['PROFILE_ACCESS_DENIED'] = "У вас недостаточно прав для редактирования профайла.";
...
$MESS ['ACCOUNT_INFO_SENT_UKR'] = "Контрольний рядок, а також ваші реєстраційні дані були вислані по E-Mail. Будь ласка, дочекайтеся приходу листа, так як контрольный рядок змінюється при кожному запиті.";
...
$MESS ['ACCESS_DENIED_FILE'] = "Просмотр файла #FILE# запрещен.";
...
$MESS ['MAIN_GP_PASSWORD_LENGTH_UKR'] = "Пароль повинен бути не менше #LENGTH# символів довжиною";
...
$MESS ['FORMATNAME_NONAME'] = "Безымянный";
?>
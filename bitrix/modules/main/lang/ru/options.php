...
$MESS ['MAIN_EMAIL'] = "E-Mail адрес или список адресов через запятую на который будут дублироваться все исходящие сообщения:";
...
$MESS ['MAIN_OPTION_SERVERNAME'] = "URL сайта (без http://): <small>Например: www.mysite.com</small>";
...
$MESS ['MAIN_OPTION_AUTH_COMP2'] = "Использовать Компоненты 2.0 для авторизации и регистрации:";
$MESS ['main_options_use_editor'] = "Использовать визуальный редактор для редактирования шаблонов сайта:";
...
$MESS ['SUBORDINATE_GROUPS'] = "Группы пользователей, профайлы которых можно изменять";
...
$MESS ['MAIN_REGISTER_EMAIL_UNIQ_CHECK'] = "Проверять E-mail на уникальность:";

...
define('DELIVERY_CPCR_SERVER_POST_ADDITIONAL', 'SMS=0&Inptype=2&PostType=1&PlatType=2&Weight35=0&Weight80=0&DuesOrder=0&GabarythB=0'); // additional POST data
...
class CDeliveryCPCR
{
	...
	function Calculate($profile, $arConfig, $arOrder, $STEP)
	{
		...
		$cache_id = "sale|8.5.2|cpcr|".$arConfig["category"]['VALUE']."|".$arLocationFrom["ORIGINAL"]["COUNTRY_ID"]."|".$arLocationFrom["ORIGINAL"]["CITY_ID"]."|".$arLocationTo["ORIGINAL"]["COUNTRY_ID"]."|".$arLocationTo["ORIGINAL"]["CITY_ID"];

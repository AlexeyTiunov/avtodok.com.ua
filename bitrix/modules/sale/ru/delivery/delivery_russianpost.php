...
class CDeliveryRUSSIANPOST
{
	...
	function Compability($arOrder, $arConfig)
	{
		...
		if (
			strtoupper($arLocationFrom["CITY_NAME_ORIG"]) == "МОСКВА" 
			|| strtoupper($arLocationFrom["CITY_SHORT_NAME"]) == "МОСКВА" 
			|| strtoupper($arLocationFrom["CITY_NAME_LANG"]) == "МОСКВА" 
	...
	{
		return 
			(strtoupper($arLocation["COUNTRY_NAME_ORIG"]) == "РОССИЯ"
			|| strtoupper($arLocation["COUNTRY_SHORT_NAME"]) == "РОССИЯ" 
			|| strtoupper($arLocation["COUNTRY_NAME_LANG"]) == "РОССИЯ"
			...
			|| strtoupper($arLocation["COUNTRY_NAME_ORIG"]) == "РОССИЙСКАЯ ФЕДЕРАЦИЯ" 
			|| strtoupper($arLocation["COUNTRY_SHORT_NAME"]) == "РОССИЙСКАЯ ФЕДЕРАЦИЯ"
			|| strtoupper($arLocation["COUNTRY_NAME_LANG"]) == "РОССИЙСКАЯ ФЕДЕРАЦИЯ"

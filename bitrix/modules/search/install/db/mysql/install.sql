...
(
	...
	MODULE_ID		VARCHAR(50)	NOT NULL REFERENCES B_MODULE (ID),
...
(
	SEARCH_CONTENT_ID	INT(11)		NOT NULL REFERENCES B_SEARCH_CONTENT (ID),
	GROUP_ID		INT(11)		NOT NULL REFERENCES B_GROUP (ID),
	UNIQUE UX_B_SEARCH_CONTENT_GROUP (SEARCH_CONTENT_ID, GROUP_ID)
);

...
function stemming_stop_ru($sWord)
{
	...
	if(!$stop_list)
	{
		$stop_list = array (
			...
			"ИЗ"=>0,"ИЛ"=>0,"ИМ"=>0,"ИХ"=>0,"КАК"=>0,"КОГД"=>0,"КТО"=>0,"ЛИ"=>0,"ЛИБ"=>0,
...
{
	return str_replace(array("Ё"), array("Е"), ToUpper($sText));
}
...
function stemming_ru($word)
{
	...
	//Exceptions
	static $STEMMING_RU_EX = array("БЕЗЕ"=>true,"БЫЛЬ"=>true,"МЕНЮ"=>true,"ГРАНАТ"=>true,"ГРАНИТ"=>true);

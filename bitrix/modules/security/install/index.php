...
Class security extends CModule
{
	...
	function InstallDB($arParams = array())
	{
		...
		if(!$DB->Query("SELECT 'x' FROM b_sec_iprule WHERE 1=0", true))
		{
			...
			require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/security/install/tasks/install.php");
		}
	...
	function UnInstallDB($arParams = array())
	{
		...
		if(!array_key_exists("savedata", $arParams) || $arParams["savedata"] != "Y")
		{
			...
			require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/security/install/tasks/uninstall.php");
		}

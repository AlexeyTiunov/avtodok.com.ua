...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/products.xml"; 
$iblockCode = "furniture_products_".WIZARD_SITE_ID; 
$iblockType = "products"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/random.php", array("PRODUCTS_IBLOCK_ID" => $iblockID));

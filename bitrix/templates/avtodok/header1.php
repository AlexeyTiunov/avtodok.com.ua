	...
	"ACTIVE_COMPONENT" => "Y"
       ...
       <div id="topmenuform">
           <form name="datasearch" enctype="multipart/form-data" action="/autodoc/search.php?lang=s1" method="POST">
             <input id="forminput" type="text" name="ICODE" size="30" value="Быстрый Поиск по Коду детали" />
             <input type="image" src="images/button.gif"  name="button.gif" />
           </form>
        </div>
...
<!-- #top_menu-->
           ...
           <div id ="hedpic"> <img src="/images/headpic2.jpg" / >
  </div>
           <div id ="underpic">   </div>  
 	 	</div>

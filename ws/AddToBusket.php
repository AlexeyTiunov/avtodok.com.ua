...
function getShortBrandName($brandCode)
{
    global $DB;     
    $sql="SELECT PROPERTY_71 as ShortName FROM b_iblock_element_prop_s14 WHERE IBLOCK_ELEMENT_ID={$brandCode} LIMIT 1";
    $result=$DB->Query($sql);     
    $ShortName=$result->Fetch()['ShortName'];
...
function getBasketPartsQuantity()
{
 ...
 ////////////////////////////////////////// 
   if(isset($_POST['getBasketPartsQuantity']))
 {
     
   echo $_POST['getBasketPartsQuantity']();  
 }
...
{
$_GET["rcode"]=$_POST['RegionCode'];
$_GET["quantity"]=$_POST['Quantity'];
$_GET['icode']=$_POST['ItemCode'];
$_GET['bcode']=$_POST['BrandCode'];
$_GET['bscode']= getShortBrandName($_GET['bcode']);
$_GET['caption']=$_POST['Caption'];
$_GET['price']=$_POST['PriceUSD'];
